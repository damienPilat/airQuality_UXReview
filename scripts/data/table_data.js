let table_data = {
    'simDiff': {
        ...
        value:
            ...
            '</tr>' +
            '<tr>' +
            '   <td class="first-row">Weather Applications</td>' +
            '   <td class="first-row">Air Quality Applications</td>' +
            '</tr>' +
            '<tr>' +
    ...
    'reqGather': {
        ...
        value:
            ...
            '</tr>\n' +
            '<tr>\n' +
            '    <td>The user must be able to view the latest air quality indicator (AQI) for a given location.</td>\n' +
            '    <td>Core</td>\n' +
            '</tr>\n' +
            '<tr>\n' +
            '    <td>The user must be able to view additional levels of air pollutants.</td>\n' +
            '    <td>Core</td>\n' +
            '</tr>\n' +
            '<tr>\n' +
            '    <td>The user must be able to view prediction levels for key pollutants.</td>\n' +
            '    <td>Optional</td>\n' +
            '</tr>\n' +
            '<tr>\n' +
            '    <td>The user must be able to search for cities.</td>\n' +
            '    <td>Core</td>\n' +
            '</tr>\n' +
            '<tr>\n' +
            '    <td>The user must be able to favourite cities.</td>\n' +
            '    <td>Optional</td>\n' +
            '</tr>\n' +
            '<tr>\n' +
            '    <td>The user must be able to view their favourite cities and edit them (i.e. remove them from the list).</td>\n' +
            '    <td>Optional</td>\n' +
            '</tr>\n' +
            '<tr>\n' +
            '    <td>The user must be able to view the latest AQI after selecting a city from their favourites.</td>\n' +
            '    <td>Optional</td>\n' +
            '</tr>\n' +
            '<tr>\n' +
            '    <td>The user must be able to sign up.</td>\n' +
            '    <td>Core</td>\n' +
            '</tr>\n' +
            '<tr>\n' +
            '    <td>The user must be able to login after signing up.</td>\n' +
            '    <td>Core</td>\n' +
            '</tr>\n' +
            '<tr>\n' +
            '    <td>The user must be able to access a range of settings.</td>\n' +
            '    <td>Core</td>\n' +
            '</tr>\n' +
            '<tr>\n' +
            '    <td>The user must be able to access an app FAQ.</td>\n' +
            '    <td>Optional</td>\n' +
            '</tr>\n' +
            '<tr>\n' +
            '    <td>The user must be able to access their account details.</td>\n' +
            '    <td>Core</td>\n' +
            '</tr>\n' +
            '<tr>\n' +
            '    <td>The user must be able to access information about the company and product.</td>\n' +
            '    <td>Optional</td>\n' +
            '</tr>\n' +
            '<tr>\n' +
            '    <td>The user must be able to allow the app to use their current location.</td>\n' +
            '    <td>Optional</td>\n' +
            '</tr>\n' +
            '<tr>\n' +
            '    <td>The user must be able to close their account.</td>\n' +
            '    <td>Core</td>\n' +
            '</tr>\n' +
            '</table>'
    },
    'userTesting': {
        ...
        value:
            ...
            '    </tr>\n' +
            '    <tr>\n' +
            '        <td rowspan="2">Favourites View</td>\n' +
            ...
            '    </tr>\n' +
            '    <tr>\n' +
            '        <td rowspan="2">Search Action View</td>\n' +
            ...
            '    </tr>\n' +
            '    <tr>\n' +
            '        <td rowspan="2">Search Bar View</td>\n' +
            '        <td>Two icons side by side area bit confusing as to what their use are for.</td>\n' +
            '    </tr>\n' +
            '    <tr>\n' +
